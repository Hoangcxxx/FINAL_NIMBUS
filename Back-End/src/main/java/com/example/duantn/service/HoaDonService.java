...
import com.example.duantn.dto.TrangThaiHoaDonDTO;
...
//            List<TrangThaiHoaDon> chiTietList = hoaDonChiTietRepository.findByHoaDon_IdHoaDon(hoaDon.getIdHoaDon());
//            dto.setListtrangthaihoadon(chiTietList.stream()
//                    .map(chiTiet -> {
//                        TrangThaiHoaDon spDTO = new TrangThaiHoaDon();
//
//                    })
//                    .collect(Collectors.toList()));
        ...
        private void saveVNPayPayment (HoaDon hoaDon, String generatedMaHoaDon, HoaDonDTO hoaDonDTO, HttpServletRequest
        req){
            try {
