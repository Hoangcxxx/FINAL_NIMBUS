...
public class HoaDonChiTietQuery {
    ...
    public static final String GET_TONG_SO_LUONG_DH_CHO ="\tselect COUNT(*) as so_luong_dh_cho from hoa_don hd\n" +
            "\tJOIN \n" +
            "    trang_thai_hoa_don th ON hd.id_trang_thai_hoa_don = th.Id_trang_thai_hoa_don\n" +
            "\twhere th.Id_trang_thai_hoa_don = 1";
    public static final String GET_TONG_SO_LUONG_DH_DANG_GIAO="\tselect COUNT(*) as so_luong_dh_dang_giao from hoa_don hd\n" +
            "\tJOIN \n" +
            "    trang_thai_hoa_don th ON hd.id_trang_thai_hoa_don = th.Id_trang_thai_hoa_don\n" +
            "\twhere th.Id_trang_thai_hoa_don = 2";
    public static final String GET_TONG_SO_LUONG_DH_HOAN_THANH ="\tselect COUNT(*) as so_luong_dh_hoan_thanh from hoa_don hd\n" +
            "\tJOIN \n" +
            "    trang_thai_hoa_don th ON hd.id_trang_thai_hoa_don = th.Id_trang_thai_hoa_don\n" +
            "\twhere th.Id_trang_thai_hoa_don = 3";
    public static final String GET_TONG_SO_LUONG_DH_HUY_BO ="\tselect COUNT(*) as so_luong_dh_huy_bo from hoa_don hd\n" +
            "\tJOIN \n" +
            "    trang_thai_hoa_don th ON hd.id_trang_thai_hoa_don = th.Id_trang_thai_hoa_don\n" +
            "\twhere th.Id_trang_thai_hoa_don = 4";
}
